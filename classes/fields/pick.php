...
class PodsField_Pick extends PodsField {
	...
	public function simple_objects() {
		...
		if ( $this->setup_related_objects( true ) || null === self::$names_simple ) {
	...
	public function get_object_data( $object_params = null ) {
		...
		if ( null === $data ) {
			...
			if ( 'custom-simple' === $options[ self::$type . '_object' ] ) {
				...
				$simple = true;
			} elseif ( $this->setup_related_objects( true ) && isset( self::$related_objects[ $options[ self::$type . '_object' ] ] ) && isset( self::$related_objects[ $options[ self::$type . '_object' ] ]['data_callback'] ) && is_callable( self::$related_objects[ $options[ self::$type . '_object' ] ]['data_callback'] ) ) {
